...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	override function create()
	{
		...
		leftIcon = new FlxSprite().makeGraphic(150, 150);
		rightIcon = new FlxSprite().makeGraphic(150, 150);
	...
	function addSongUI():Void
	{
		...
		var characters:Array<String> = ['dad'];
	...
	function loadSong(daSong:String):Void
	{
		...
		vocals = new FlxSound().loadEmbedded((Paths.inst(daSong.toLowerCase())));
