	...
	**/
	...
	override function create()
	{
		...
		var tipText:FlxText = new FlxText(UI_box.x, UI_box.y + UI_box.height + 6, 0, "W/S or Mouse Wheel - Change Conductor's strum time
			...
			\nR - Reset section\n", 16);
		tipText.setFormat('assets/fonts/InriaSans-Bold', 16, FlxColor.WHITE, LEFT /*, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK*/);
	...
	function updateGrid():Void
	{
		...
		for (i in _song.notes[curSection].sectionNotes)
		{
			...
			if (note.noteData < 0)
			{
				...
				daText.setFormat('assets/fonts/InriaSans-Bold', 16, FlxColor.WHITE, LEFT /*, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK*/);
				daText.xAdd = -410;
				daText.yAdd = -5;
				daText.borderSize = 1;
