...
class FunkinSoundTray extends FlxSoundTray
{
  ...
  public function new()
  {
    ...
    var bg:Bitmap = new Bitmap(openfl.utils.Assets.getBitmapData(Paths.image("soundtray/volumebox")));
    ...
    var backingBar:Bitmap = new Bitmap(openfl.utils.Assets.getBitmapData(Paths.image("soundtray/bars_10")));
    backingBar.x = 9;
    backingBar.y = 5;
    ...
    for (i in 1...11)
    {
      var bar:Bitmap = new Bitmap(openfl.utils.Assets.getBitmapData(Paths.image("soundtray/bars_" + i)));
      bar.x = 9;
      bar.y = 5;
  ...
  override public function show(up:Bool = false):Void
  {
    ...
    visible = true;
    active = true;
    var globalVolume:Int = Std.int(FlxG.sound.volume * 10);
